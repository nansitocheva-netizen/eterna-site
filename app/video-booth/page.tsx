...
export default function VideoBooth() {
  ...
  else if (item === "Видео будка") window.location.href = "/video-booth";
  else if (item === "Видео албум") window.location.href = "/video-album";
  else if (item === "Галерия") window.location.href = "/gallery";
  else if (item === "Контакти") window.location.href = "/contact";
}}
              style={{
                cursor: "pointer",
                color: "#3b342d",
